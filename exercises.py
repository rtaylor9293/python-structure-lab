...
# Use a for loop to iterate gover the strings in foods and append each string to meal.

def combine_foods():
    foods = ("Pasta", "Tacos", "Steak", "Burger")
    meal = " "
    for i in foods:
        meal += i + " "
    return meal
...
def create_awesome_students():
    students = ["Billie", "Mark", "Leo"]
    awesome_students = [f"{n} is awesome!" for n in students ]
...
def filter_foods_with_a():
    ...
    foods_with_an_a = [n for n in foods if ("a" in n.lower())]
